	...
	if(confirm('서비스를 진행 하시겠습니까?')){
		...
		$.ajax({
			...
			success: function(result){
					...
					map.destroy();
					init();
				//	getRoute(result.m_lon, result.m_lat ,result.m_name ,result.mo_no, result.e_name);

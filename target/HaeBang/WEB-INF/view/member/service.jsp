...
<body>
   <!-- <div id="wrapper"> -->
      ...
      <div style="margin-left:15%;">* 정기형 서비스는 상담 or 방문시 개월단위로 선택하실 수 있습니다.</div>
      <div style="margin-left:15%;">* 정기형 서비스는 1회무료 방문이 포함됩니다.</div>
      
      </div>
      <br/>
      <hr size="5" style="width: 70%;"/>
      <hr size="5" style="width: 70%;"/>
      <table class="table table-striped table-bordered table-hover"
         style="width: 70%;" align="center" text-align="center">
         <thead>
      ...
      <div>
      <table class="table table-striped table-bordered table-hover"
         style="margin-top:150px; width: 70%;" align="center">
      ...
      <div style="margin-left:15%;">* 정기형 서비스는 상담 or 방문시 개월단위로 선택하실 수 있습니다.</div>
      <div style="margin-left:15%;">* 정기형 서비스는 1회무료 방문이 포함됩니다.
      </div><br/>
      <hr size="5" style="width: 70%;"/>
      <hr size="5" style="width: 70%;"/>
      <table class="table table-striped table-bordered table-hover"

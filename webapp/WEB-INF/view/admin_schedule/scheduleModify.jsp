...
<form action="${ pageContext.request.contextPath }/admin/sceduleModify" method="post" onsubmit="validate()">
           ...
           <p class="lead" style="padding-top :20%;">담당 직원 정보</p>
            ...
            <div class="col-sm-6">
            	<div class="form-group" style="padding-bottom:20px;">
                    ...
                    <div class="col-sm-10">
          	           <input class="form-control" id="mod_mo_orderNo" name="mo_orderNo" ></input>                        
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-bottom:20px;">
                 ...
                 <div class="form-group" style="padding-bottom:20px;">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="mod_periodType" name="periodType" ></input>         
                    </div>
                </div> 
            	 ...
            	 <div id="mod_type4">			
            		<div id="freq">
						<div class="form-group" style="padding-bottom:20px;">
						    ...
						    <div class="col-sm-4">
						    	<input class="form-control" id="mod_mo_freqType" name="mo_freqType"></input>                      
						    </div>
						    
						    <label for="new_pod_require" class="col-sm-2 control-label bg-danger">반복</label>
						    <div class="col-sm-4">
						        <input class="form-control" id="mod_mo_freqCycle" name="mo_freqCycle" ></input>                        
						    </div>
						</div>
						...
						<div class="form-group" style="padding-bottom:20px;">
						    ...
						    <div class="col-sm-4">
						        <input class="form-control " id="mod_mo_total" name="mo_total" ></input>                        
						    </div>
						</div>
            		</div>
            	</div>

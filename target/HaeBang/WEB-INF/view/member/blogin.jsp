		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<form action="${ pageContext.request.contextPath }/member/blogin" name="form1" method="post" role="form" onsubmit="return b()">
						<div class="form-group">
							
								<input type="text" name="m_name" class="form-control" id="m_name"
									placeholder="이름을 입력해주세요" style="width:50%;" />
						...
						<div class="form-group">
							<input type="text" class="form-control" name="m_phone"
								id="m_phone" placeholder="PHONE NUMBER" style="width:50%;" />
							<div class="validation"></div>
						</div>

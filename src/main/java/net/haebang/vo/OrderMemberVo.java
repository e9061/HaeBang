...
public class OrderMemberVo {
   ...
   public String toString() {
      return "OrderMemberVo [mo_no=" + mo_no + ", s_no=" + s_no + ", m_no=" + m_no + ", mo_regDate=" + mo_regDate
            + ", mo_startTime=" + mo_startTime + ", mo_endTime=" + mo_endTime + ", mo_memo=" + mo_memo
            + ", mo_svcName=" + mo_svcName + ", mo_cnt=" + mo_cnt + ", mo_total=" + mo_total + ", mo_freq="
            + mo_freq + ", mo_star=" + mo_star + ", mo_starComment=" + mo_starComment + ", mo_type=" + mo_type
            + "]";
   }
   public OrderMemberVo(int mo_no, int s_no, int m_no, String mo_regDate, String mo_startTime, String mo_endTime,
         String mo_memo, String mo_svcName, String mo_cnt, String mo_total, String mo_freq, String mo_star,
         String mo_starComment, String mo_type) {
      this.mo_no = mo_no;
      this.s_no = s_no;
      this.m_no = m_no;
      this.mo_regDate = mo_regDate;

		...
		<section id="content">
			<div class="container">
				<div class="row">
					...
					<input type="button" onclick="doAction()" value="글쓰기" /> </article>
						</article>
						<article>
							<div class="post-slider">
								...
								<div id="post-slider" class="flexslider">
									<ul class="slides">
										<li>
											<img src="resources/img/dummies/blog/img1.jpg" alt="" />
										</li>
										<li>
											<img src="resources/img/dummies/blog/img2.jpg" alt="" />
										</li>
										<li>
											<img src="resources/img/dummies/blog/img3.jpg" alt="" />
										</li>
									</ul>
								</div>
								<!-- end flexslider -->
					...
					<div class="col-lg-4">
						<aside class="right-sidebar">
							...
							<div class="widget">
								...
								<ul class="recent">
									<li>
										<img src="resources/img/dummies/blog/65x65/thumb1.jpg" class="pull-left" alt="" />
									...
									<li>
										<a href="#"><img src="resources/img/dummies/blog/65x65/thumb2.jpg" class="pull-left" alt="" /></a>
									...
									<li>
										<a href="#"><img src="resources/img/dummies/blog/65x65/thumb3.jpg" class="pull-left" alt="" /></a>

...
function fullSchedules1234(){	 
			
		window.location.href="${ pageContext.request.contextPath}/ceo/allSchedule"
...
function setCalendar(data){ 
	var jsonData = data;
	   ...
	   $("#calendar").fullCalendar({
	   	header: {
	           left: 'prev,next today, allSchedules, mySchedules',
	           center: 'title',
...
<input style="margin-right:120px;" type="button" class="btn btn-theme" id="fullSchedules" onclick = "fullSchedules1234()" value="전체일정보기" >

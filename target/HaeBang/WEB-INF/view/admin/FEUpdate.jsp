					...
					<div>
						...
						<form:form commandName="QnA" method="PUT" >
							<table border="1" class="table table-striped table-bordered table-hover" style="width: 1120px;">
								<tr>
									<th width="25%">제목</th>
									<td><form:input path="q_title" class="form-control" default="${ QnA.q_title }" /></td>
								</tr>
								<tr>
									<th width="25%">글쓴이</th>
								...
								<tr>
									<th width="25%">내용</th>
									<td><form:textarea rows="7" cols="10" class="form-control" path="q_content" default="${ QnA.q_title }"/></td>
								<!-- </tr>

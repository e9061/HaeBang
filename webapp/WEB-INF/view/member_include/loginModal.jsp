         ...
         <div class="modal-body">
            <form:form commandName="Member"  method="post">
               <div class="form-group">
                  ...
                  <form:input class="form-control" placeholder="Username" required="required" path="m_id"/>
               </div>
               <div class="form-group">
                  <i class="fa fa-lock"></i>
                  <form:password class="form-control" placeholder="Password" required="required" path="m_password"/>               
               </div>

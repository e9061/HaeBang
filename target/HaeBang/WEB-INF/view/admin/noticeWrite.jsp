...
<body>
	...
	<div class="container" style="margin: auto;">
		<form:form action="${ pageContext.request.contextPath }/admin/noticeWrite" commandName="noticeBoardVo" method="POST" onsubmit="return validate()">
		        	...
		        	<tbody align="center">
				            ...
				            <tr>
	   	 					...
	   	 					<div  style="float: right;">
									<a href="${ pageContext.request.contextPath }/admin/adminNotice?n_type=${beforeNtype}">
									<input type="button" value="이전" class="btn btn-theme">
									</a>
					            	<input type="submit" value="글 등록" class="btn btn-theme">
	   	 					</div>
		</form:form>
	</div>

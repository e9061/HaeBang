         ...
         <div class="navbar navbar-default navbar-static-top">
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.jsp"><span>H</span>aeBang</a>
               </div>
               <div class="navbar-collapse collapse ">
                  ...
                  <c:choose>
                     <c:when test="${ empty MemberVO }">
                        <li><a href="/HaeBang/WEB-INF/view/member/JoinMemberForm.jsp">회원가입</a></li> 
                           <li><a href="/HaeBang/WEB-INF/view/member/LoginMember.jsp">로그인</a></li>
                           </c:when>
                     <c:otherwise>
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li><a href="blog.jsp">blog</a></li>
                            ...
                            <li><a href="/HaeBang/WEB-INF/view/member/LogoutMember.jsp">로그아웃</a></li>
                     </c:otherwise>
                  </c:choose>
                  <!--  -->
                     <!-- <li class="dropdown">
